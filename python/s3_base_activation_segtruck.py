...
WITH base_unificada AS (
    ...
    SELECT 
        ...
        CAST(
            COALESCE(
                CAST(irs.DATE_INITAL_EFFECT AS DATE), 
                CAST(irs.DATE_FINAL_EFFECT AS DATE) - INTERVAL '364 days'
            ) AS DATE
        ) AS inicio_vig,
...
excel_path = r"C:\Users\raphael.almeida\Documents\Processos\relatorio_ativacoes_cancelamentos\reports\relatorio_ativos_varchar3.xlsx"
