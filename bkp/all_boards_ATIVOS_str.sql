WITH base_ativos AS (
    ...
    -- DADOS DO CONTRATO
        ...
        TRY_CAST(irs.id_renovated_set AS BIGINT) as "conjunto_renovado",
    ...
    -- DADOS DE DATAS
        ...
        TRY_CAST(coalesce(TRY_CAST(irs.DATE_INITAL_EFFECT AS DATE), date_add('day', -364, TRY_CAST(irs.DATE_FINAL_EFFECT AS DATE))) AS DATE) as "inicio_vig",
        TRY_CAST(irs.date_activation AS DATE) as "data_ativacao",
    ...
    -- DADOS DO CONTRATO
        ir.id as "matricula",
        irs.id as "conjunto",
        irs.id_renovated_set as "conjunto_renovado",
        cata.fantasia as "unidade",
        v.DESCRICAO as "consultor",
        iss.description as "status_conjunto",
        cat.nome as "cliente",
